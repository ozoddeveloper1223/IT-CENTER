   ...
   <section class="contact">
      ...
      <div class="row">
         ...
         <form action="" method="post">
            <h3>get in touch</h3>
            <input type="text" placeholder="enter your name" required maxlength="50" name="name" class="box">
            <input type="email" placeholder="enter your email" required maxlength="50" name="email" class="box">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <h3>Email address</h3>
            <a href="mailto:itcentersupport@gmail.com">IT-CENTER@gmail.com</a>
            <a href="mailto:itcenter_admins@gmail.com">IT-CENTER-SUPPORT@gmail.com</a>
         </div>
